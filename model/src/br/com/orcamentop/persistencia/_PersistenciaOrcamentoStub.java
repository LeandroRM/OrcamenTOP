 ...
 */
public class _PersistenciaOrcamentoStub extends ObjectImpl implements PersistenciaOrcamento {
    
    // Type-specific CORBA::Object operations
    private static String[] __ids = {
        "IDL:br/com/orcamentop/persistencia/PersistenciaOrcamento:1.0"};
    ...
    public boolean salvar(ListaOrcamento orcamento) {
        ...
        try {
            ...
            ListaOrcamentoHelper.write(out, orcamento);
            in = _invoke(out);
    ...
    public ListaOrcamento carregar() {
        ...
        try {
            ...
            in = _invoke(out);
            ListaOrcamento listaOrcamento = ListaOrcamentoHelper.read(in);
